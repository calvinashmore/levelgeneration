  ...
  public static void main(String args[]) {
    ...
    JPanel panel = new JPanel() {
      ...
      protected void paintComponent(Graphics g) {
        ...
        new ConnectionRenderer().render(
                P1Geometry.P1ConnectionTransformation.create(Point3i.ZERO, P1Geometry.WEST), g2);
        new ConnectionRenderer().render(
                P1Geometry.P1ConnectionTransformation.create(Point3i.create(2, 3, 0), P1Geometry.EAST), g2);
        new ConnectionRenderer().render(
                P1Geometry.P1ConnectionTransformation.create(Point3i.create(2, 1, 0), P1Geometry.NORTH), g2);
        new ConnectionRenderer().render(
                P1Geometry.P1ConnectionTransformation.create(Point3i.create(0, 0, 0), P1Geometry.SOUTH), g2);

        new VolumeRenderer().render(new Volume3i(ImmutableList.of(Point3i.create(2,0,0))), 0, g2);
        new ConnectionRenderer().render(
                P1Geometry.P1ConnectionTransformation.create(Point3i.create(2, 0, 0), P1Geometry.SOUTH), g2);
      }
    };
